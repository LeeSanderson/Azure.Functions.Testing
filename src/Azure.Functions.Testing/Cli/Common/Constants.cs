...
namespace Azure.Functions.Testing.Cli.Common
{
    internal static class Constants
    {
        ...
        public const string AspNetCoreSuppressStatusMessages = "ASPNETCORE_SUPPRESSSTATUSMESSAGES";
        ...
        public static readonly Dictionary<WorkerRuntime, IEnumerable<string>> WorkerRuntimeImages = new()
        {
